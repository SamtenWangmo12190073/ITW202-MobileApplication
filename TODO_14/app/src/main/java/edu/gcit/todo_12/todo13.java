...
public class todo13 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.spinnerDropdown, R.layout.support_simple_spinner_dropdown_item);
        if(spinner!=null){
    ...
    public void radiobtn(View view) {
        ...
        switch (view.getId()){
            case R.id.sameday:
                displayToast(getString(R.string.radiob1));
                break;

            case R.id.nextday:
                displayToast(getString(R.string.radiob2));
                break;
            case R.id.pickup:
                displayToast(getString(R.string.radiob3));
                break;
            default:
                break;
        }
